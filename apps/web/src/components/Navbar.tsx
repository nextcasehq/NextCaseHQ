...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-white/90 backdrop-blur-md border-b border-neutral-100 z-50 px-6 md:px-12 flex items-center justify-between font-sans">
