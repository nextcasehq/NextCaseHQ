  ...
  return (
    <footer className="border-t border-neutral-200/70 bg-white">
      <div className="mx-auto w-full max-w-7xl px-6 py-14 md:px-12">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2.5 group">
              <svg
                className="h-7 w-7 text-[#111111] transition-colors group-hover:text-indigo-600"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2.5"
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-neutral-100 pt-6 text-center sm:flex-row sm:text-left">
          <p className="text-xs font-medium text-neutral-500">
            {"\u00A9"} {new Date().getFullYear()} NextCaseHQ Technologies Inc. All rights reserved.
          </p>
          <p className="text-[11px] font-mono font-bold uppercase tracking-widest text-neutral-400">
