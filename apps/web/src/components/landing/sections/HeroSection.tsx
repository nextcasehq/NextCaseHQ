  ...
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="relative mx-auto flex w-full max-w-4xl flex-col items-center px-6 pb-10 pt-8 text-center md:px-12 md:pt-10 lg:pt-12">
        ...
        <div className="mt-4 flex w-full max-w-3xl flex-wrap items-center justify-center gap-2">
          {actionCards.map((card) => (
            ...
            >
              {card.label}
              <svg
                className="h-3 w-3 text-[#726B58] transition-all duration-200 group-hover:translate-x-0.5 group-hover:text-[#8A6D2F]"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2.5"
        ...
        <p className="mt-5 text-[11px] font-mono font-bold uppercase tracking-widest text-[#726B58]">
