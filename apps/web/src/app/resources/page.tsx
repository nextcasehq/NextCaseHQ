      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 py-20 lg:py-32 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <Card className="p-8 space-y-4">
            <span className="text-xs font-mono font-bold text-[#C5A059] uppercase">Compliance Guide</span>
            <h3 className="font-sans font-bold text-sm uppercase tracking-wider">The BNS/BNSS Integration Playbook</h3>
          ...
          <Card className="p-8 space-y-4">
            <span className="text-xs font-mono font-bold text-[#C5A059] uppercase">Whitepaper</span>
            <h3 className="font-sans font-bold text-sm uppercase tracking-wider">Zero-Knowledge Envelopes for Litigation</h3>
