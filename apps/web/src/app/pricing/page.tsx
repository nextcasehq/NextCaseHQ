      ...
      <div className="flex-1 max-w-7xl mx-auto px-6 py-20 lg:py-32 w-full">
        ...
        <div className="max-w-md w-full bg-white border border-[#C6A253]/20 rounded-2xl p-8 shadow-sm mx-auto mb-12">
          <div className="flex justify-between items-center mb-6 border-b border-[#111111]/10 pb-4">
            <div>
              <h2 className="font-sans font-extrabold text-lg text-[#111111]">Counsel Pro</h2>
              <p className="text-xs text-[#111111]/70 font-semibold font-mono mt-0.5">UNLIMITED WORKSPACES</p>
            </div>
            <div className="text-right">
              <span className="font-sans text-3xl font-black text-[#111111]">$49</span>
              <span className="text-xs text-[#111111]/70 font-semibold">/mo</span>
            </div>
          </div>
          ...
          <Link
            href="/login"
            className="block text-center w-full bg-[#8A6D2F] hover:bg-[#6F5624] text-white font-sans font-bold text-xs py-3.5 rounded-xl transition-all"
          >
