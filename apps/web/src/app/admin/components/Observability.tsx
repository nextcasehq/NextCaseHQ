  ...
  return (
    <div className="space-y-6 bg-white border border-[#F4EEE0] p-6 rounded-2xl shadow-sm">
      <div>
        ...
        <p className="text-sm text-[#726B58] font-serif italic mt-0.5">Live OpenTelemetry dashboard indicators, trace routes, and edge runtime performance budgets.</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="bg-[#241E17] text-[#CFC3A8] font-mono text-xs p-4 rounded-xl space-y-2 max-h-48 overflow-y-auto shadow-inner">
          <div className="text-[#6F5624]">[2026-07-15 18:42:01] INF: Initialized crypto envelope provider</div>
          <div className="text-emerald-400">[2026-07-15 18:42:12] INF: Row-Level Security isolation check complete for tenant 0000a</div>
          <div className="text-[#6F5624]">[2026-07-15 18:42:15] INF: Stream chunk validation - 202 Accepted</div>
