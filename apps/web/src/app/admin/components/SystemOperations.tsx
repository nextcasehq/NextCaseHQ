  ...
  return (
    <div className="space-y-6 bg-white border border-[#F4EEE0] p-6 rounded-2xl shadow-sm">
      <div>
        ...
        <p className="text-sm text-[#726B58] font-serif italic mt-0.5">Force system state maintenance tasks, execute structural cache flushes, and trigger live sentinel evaluations.</p>
      </div>
        ...
        {operations.map((op, idx) => (
          <div key={idx} className="flex flex-col md:flex-row md:items-center justify-between p-4 border border-[#F4EEE0] rounded-xl gap-4 hover:border-[#E7DFC9] transition-colors">
            <div>
              ...
              <p className="text-xs text-[#726B58] font-serif italic mt-0.5">Category: {op.type} • Status: Ready</p>
            </div>
