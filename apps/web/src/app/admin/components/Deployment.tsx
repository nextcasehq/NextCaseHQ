  ...
  return (
    <div className="space-y-6 bg-white border border-neutral-100 p-6 rounded-2xl shadow-sm">
      <div>
        ...
        <p className="text-sm text-neutral-400 font-serif italic mt-0.5">Vercel deployments sync status, GitHub webhook integrations, and branch version maps.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-5 border border-neutral-100 rounded-xl space-y-3">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs font-semibold text-neutral-600">
              ...
              <span className="text-indigo-600 font-black">SYNCED</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-5 border border-neutral-100 rounded-xl space-y-3">
          ...
          <p className="text-[11px] text-neutral-400">Any push to <code>main</code> triggers automated build, test coverage verification, and live rollout.</p>
        </div>
      </div>
    </div>
  );
