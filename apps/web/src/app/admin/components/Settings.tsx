  ...
  return (
    <div className="space-y-6 bg-white border border-[#F4EEE0] p-6 rounded-2xl shadow-sm">
      <div>
        ...
        <p className="text-sm text-[#B0A588] font-serif italic mt-0.5">Toggle live debugging logs, audit trails, secure cookie attributes, and key encryption parameters.</p>
      </div>
        ...
        {[
          ...
          <div key={idx} className="flex justify-between items-center p-4 border border-[#FBF8F1] rounded-xl">
            <div>
              ...
              <p className="text-xs text-[#B0A588] mt-0.5">{item.desc}</p>
            </div>
