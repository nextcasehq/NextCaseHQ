  ...
  return (
    <div className="space-y-6 bg-white border border-[#F4EEE0] p-6 rounded-2xl shadow-sm">
      <div>
        ...
        <p className="text-sm text-[#726B58] font-serif italic mt-0.5">Control pipeline rates, configure context window allocation, and view Indian PII scrubbing logs.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-5 border border-[#F4EEE0] rounded-xl space-y-3">
          ...
          <p className="text-xs text-[#726B58]">Current Default Model: <code>Claude 3.5 Sonnet v2</code></p>
        ...
        <div className="p-5 border border-[#F4EEE0] rounded-xl space-y-3">
          ...
          <p className="text-xs text-[#726B58]">Indian PAN/Aadhaar scrubbing is fully active at edge API controllers.</p>
