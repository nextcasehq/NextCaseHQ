...
| DB-5 | Search, AI, File Storage (Real Persistence), Billing, Messaging | PENDING | Each explicitly deferred to its own future milestone per Product Owner decision. | High |
